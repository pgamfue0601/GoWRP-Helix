...
-- Incluimos los modelos para fixearlos
ix.anim.SetModelClass("models/ig_commissar.mdl", "player")
ix.anim.SetModelClass("models/wk/comm/wk_comm.mdl", "player")
ix.anim.SetModelClass("models/wk/comm/wk_comm_fm.mdl", "player")

ix.anim.SetModelClass("models/dizcordum/wk/ogryn/ogryn_bald.mdl","player");
ix.anim.SetModelClass("models/dizcordum/wk/ogryn/ogryn_krieg.mdl","player");
ix.anim.SetModelClass("models/dizcordum/wk/ogryn/ogryn_bonehead.mdl","player");
ix.anim.SetModelClass("models/dizcordum/wk/ogryn/ogryn_bullgryn.mdl","player");
...
do
	...
	function CLASS:OnChatAdd(speaker, text)
		text = speaker:IsCombine() or speaker:IsMechanicus() and string.format("<:: %s ::>", text) or text
