...
Schema.voices.Add("Humanoid", "Grito de guerra", "*Suelta un alarido de guerra.*", "lobo2.mp3")
Schema.voices.Add("Humanoid", "Guerra", "¡GUERRAAAAAAAAA!", "lobo1.mp3")
Schema.voices.Add("Humanoid", "Gusanos", "¡Voy a acabar con vosotros, malditos gusanos!", "lobo3.mp3")
Schema.voices.Add("Humanoid", "FyH", "¡Fuerza y honor!", "lobo4.mp3")
Schema.voices.Add("Humanoid", "honor", "¡HONOOOOOR! ¡HONOOOOOOOR!", "lobo5.mp3")